...
VENV ?= .venv
VENV_BIN := $(VENV)/bin
PYTHON_PATHS := scripts plugins/rubric-maker-skill/scripts plugins/rubric-maker-skill/skills plugins/oasis-ingestion/scripts plugins/oasis-ingestion/skills/oasis-prepare-ingestion/scripts plugins/oasis-ingestion/skills/oasis-prepare-ingestion/tests
